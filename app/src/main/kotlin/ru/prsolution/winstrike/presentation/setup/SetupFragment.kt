...
class SetupFragment : Fragment() {
	...
	class TimePickerFragment : DialogFragment(), TimePickerDialog.OnTimeSetListener {
		...
		override fun onCreateDialog(savedInstanceState: Bundle?): Dialog {
			...
			return TimePickerDialog(activity, AlertDialog.THEME_HOLO_DARK, this, hour, minute, DateFormat.is24HourFormat(activity))
	...
	class DatePickeFragment : DialogFragment(), DatePickerDialog.OnDateSetListener {
		...
		override fun onCreateDialog(savedInstanceState: Bundle?): Dialog {
			...
			return DatePickerDialog(activity, AlertDialog.THEME_DEVICE_DEFAULT_DARK, this, year, month, day)
		}


		override fun onDateSet(p0: DatePicker?, p1: Int, p2: Int, p3: Int) {
			Timber.d("On date picker selected")
		}

	}

	fun showDatePickerDialog(v: View) {
		val newFragment = DatePickeFragment()
