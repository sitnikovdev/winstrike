...
public class NetworkError extends Throwable {
    ...
    private static final String ERROR_MESSAGE_HEADER = "Error-MessageResponse";
    ...
    public String getAppErrorMessage() {
        ...
        return String.valueOf(((HttpException) this.error).code());
    }

    protected String getJsonStringFromResponse(final retrofit2.Response<?> response) {
        try {
            String jsonString = response.errorBody().string();
            ResponseError errorResponse = new Gson().fromJson(jsonString, ResponseError.class);
